...
export const Login = () => {
  ...
  return (
    <div className="relative w-full max-w-120 px-4">
        {/*Login Card */}
        <div
          className="w-full flex flex-col rounded-xl bg-[#191e33]/90 backdrop-blur-sm border border-[#323b67] shadow-2xl p-8 sm:p-10"
        >
          {/* Header / Logo Area*/}
          <div className="mb-8 flex flex-col items-center text-center">
            <div
              className="mb-4 flex h-16 w-16 items-center justify-center rounded-xl bg-primary/20 text-primary"
            >
          ...
          >
            ...
            <label className="flex flex-col gap-2">
              ...
              <div className="group relative flex w-full items-center">
                ...
                />
                <span
                  className="material-symbols-outlined absolute right-4 text-[#929bc9] transition-colors peer-focus:text-primary"
                  >person</span
                >
              </div>
            </label>
            ...
            <label className="flex flex-col gap-2">
              ...
              <div className="group relative flex w-full items-center">
                ...
                />
                <span
                  className="material-symbols-outlined absolute right-4 text-[#929bc9] cursor-pointer hover:text-white transition-colors peer-focus:text-primary"
                  >visibility_off</span
                >
              </div>
            </label>
            ...
            <div className="flex items-center justify-between">
              <label className="flex cursor-pointer items-center gap-2 select-none">
                ...
                />
                <span
                  className="text-sm font-medium text-[#929bc9] hover:text-white transition-colors"
                  >Remember me</span
                >
              </label>
              <a
            ...
            {/* Submit Button */}
            <button
              className="mt-2 flex w-full items-center justify-center rounded-lg bg-primary py-3.5 text-base font-semibold text-white shadow-lg shadow-primary/25 hover:bg-[#3b5bf6] active:scale-[0.98] transition-all duration-200" type="submit" 
            >
              Login
            </button>
          </form>
